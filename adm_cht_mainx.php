...
if($filtrocht==0)
    $condicion.="entregado='' and ";
if($chkfechacht==1) 
    $condicion.="($campofechacht between '$fechainicht' and '$fechafincht') and ";
if($campocht!="") {
    if($camposelcht=='id')
...
<form name="form1" id="form1" action="" method="post">
    <tr>
        ...
        <input name="primero" type="hidden" id="primero" value="<?= $primerocht?>" />
    </tr> 
                        ...
                        <div class="panelmax letra6">
                            <div id="effect-panelmax" class="ui-widget-content ui-corner-all">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="javascript: document.form1.filtrocht.value=0; document.form1.action='register_cht.php'; document.form1.submit()"><? if($filtrocht==0) echo "<strong>";?>Cheques Pendientes<? if($filtrocht==0) echo "</strong>";?></a> | <a href="javascript: document.form1.filtrocht.value=1; document.form1.action='register_cht.php'; document.form1.submit()"><? if($filtrocht==1) echo "<strong>";?>Todos los Cheques<? if($filtrocht==1) echo "</strong>";?></a>
