<?php
/*
 * Creado el 22/08/2019 11:49:21
 * Autor: gus
 * Archivo: adm_crec_che_tmp_save.php
...
$usuario=$usr->getId();
$ssql="insert into tmp_che (centro, idbanco, nrocheque, fechaorigen, fechapago, importe, nombre, cliente, idcli, usuario, tipo) values ";
