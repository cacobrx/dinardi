...
<div id="barcentral">
<form name="form1" id="form1" action="adm_crem_act_save.php" method="post">
    <tr>
                            ...
                            <div id="effect-panelmax" class="ui-widget-content ui-corner-all">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="letra6">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ptovta" id="ptovta" type="text" value="<?= $ptovta?>" size="4" maxlength="4" onkeypress="return validar(event)" style="text-align: center" /> 
                                            <input name="numero" id="numero" type="text" value="<?= $numero?>" size="8" maxlength="8" onkeypress="return validar(event)" style="text-align: center" />
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td align="right">ID Comp. Fiscal&nbsp;</td>
                                        <td><input name="idfis" type="text" class="letra6" id="idfis" size="6"  value="<?= $idfis?>" onkeypress="return validar(event)" style="text-align: center" /></td>
                                    </tr>                                      
                                    <tr>
                                    ...
                                    <tr>
                                        <td colspan="2" align="center">
                                            <input type="submit" name="Submit" value="<?= $botoncap?>" onclick="javascript: document.form1.action='adm_crem_act_save.php'; document.form1.submit()" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
