...
<script language="javascript">
    function calpreciofin() {
        ...
        pr=Math.round(pr*100000)/100000;
...
<div id="barcentral">
<form name="form1" id="form1" action="adm_cli_pre_act_save.php" method="post">
    <tr>
                        ...
                        <div class="panel960 letra6">
                            <div id="effect-panel960" class="ui-widget-content ui-corner-all">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="letra6">
                                    <tr>
                                        <td colspan="2"><a href="javascript: document.form1.action='adm_cli_pre_main.php'; document.form1.submit()"><i class="fas fa-arrow-left fa-lg" title="Volver" alt="Volver"></i></a></td>
                                    </tr>
                  
                                    <tr>
                                        <td width="35%" align="right">Precio&nbsp;</td>
                                        <td width="45%"><input name="importe" type="text" class="letra6" id="importe" size="10" maxlength="10" value="<?= $importe?>" onkeypress="return validar_punto(event)" style="text-align: center" onblur="javascript: calpreciofin(); setseleccionado(this.value)" /></td>
                                    </tr>
                                    <tr>
