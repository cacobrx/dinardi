...
require_once 'impresion/pdf_opg.php';
$conx=new conexion();
$utl=new util();
$sup=new support();
...
$ssql="select * from adm_opg1 where ($campofechaopg between '$fechainiopg' and '$fechafinopg') and adm_opg1.centro=$centrosel $condicionprv";
...
$colu=array(5,15,25,50,120,185);
$pdf=new PDF_opg("P", "mm", "A4");
$pdf->AddPage();
$pdf->Detalle();
$pdf->Output();
?>
