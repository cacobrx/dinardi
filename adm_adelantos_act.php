...
if($tarea=="A") {
    ...
    $carteltarea="Modifica Adelantos";
...
<div id="barcentral">
<form name="form1" id="form1" action="adm_adelantos_act_save.php" method="post">
    <tr>
                        ...
                        <div class="panel960 letra6">
                            <div id="effect-panel960" class="ui-widget-content ui-corner-all">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="letra6">
                                    <tr>
                                        <td colspan="2"><a href="javascript: document.form1.action='adm_adelantos_main.php'; document.form1.submit()"><i class="fas fa-arrow-left fa-lg" title="Volver" alt="Volver"></i></a></td>
                                    </tr>
                  
                                    <tr>
                                        <td align="right" width="50%">Empleado&nbsp;</td>
                                        <td width="50%">
