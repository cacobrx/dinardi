...
//    }
    ...
    if($a_com[$i]=="NC") {
        echo "<td>".number_format(($a_neto21[$i]+$a_neto10[$i]+$a_neto27[$i]+$a_exe[$i]+$a_ngr[$i])*-1,2,",","")."</td>";
        echo "<td>".number_format(($a_iva21[$i] + $a_iva10[$i] + $a_iva27[$i] + $a_imi[$i])*-1,2,",","")."</td>";    
        echo "<td>".number_format(($a_pri[$i] + $a_rti[$i] + $a_prb[$i])*-1,2,",","")."</td>";
        echo "<td>".number_format(($a_neto21[$i] + $a_neto10[$i] + $a_neto27[$i] + $a_iva21[$i] + $a_iva10[$i] + $a_iva27[$i] + $a_imi[$i] + $a_pri[$i] + $a_rti[$i] + $a_prb[$i] + $a_exe[$i] + $a_ngr[$i])*-1,2,$puntodec,"")."</td>";
    } else {
        echo "<td>".number_format(($a_neto21[$i]+$a_neto10[$i]+$a_neto27[$i]+$a_exe[$i]+$a_ngr[$i]),2,",","")."</td>";
        echo "<td>".number_format(($a_iva21[$i] + $a_iva10[$i] + $a_iva27[$i] + $a_imi[$i]),2,",","")."</td>";    
