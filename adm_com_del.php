...
//echo $ssql."<br>";
$conx->getConsulta($ssql);
$aud->regAud("Compras",$usr->getId(),"Elimina Compras: ".$com->getLetra()."-".$com->getPtovta()."-".$com->getNumero()." Prov: ".$com->getProveedor(),$centrosel);
?>
<html>
<body>
<form  name="form1" id="form1" method="post" action="adm_com_main.php">
</form>
