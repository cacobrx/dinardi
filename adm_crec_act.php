...
function pagacompletorec(i, cant, canti) {
    if(i>=0) {
        ...
        if(document.form1[importepag].value!="") {
            if(document.form1[tipocom].value=="NC" || document.form1[tipocom].value=="NCE")
                document.form1[pagar].value=-parseFloat(document.form1[importetot].value) + parseFloat(document.form1[importepag].value);
            else
                document.form1[pagar].value=parseFloat(document.form1[importetot].value) - parseFloat(document.form1[importepag].value);
        } else {
            if(document.form1[tipocom].value=="NC" || document.form1[tipocom].value=="NCE")
                document.form1[pagar].value=document.form1[importetot].value * -1;
            else
                                                    ...
                                                    <table width="100%" border="0" cellpadding="2" cellspacing="0">
                                                        ...
                                                        <tr>
                                                            <td align="center"><?= $dsup->getFechaNormalCorta($c_fec[$i])?>
                                                                ...
                                                                <input name="tipocom<?= $i?>" type="hidden" id="tipocom<?= $i?>" value="<?= $c_com[$i]?>" /></td>
                                                        ...
                                                        <? } else { ?>
                                                            <input name="pagar<?= $i?>" type="hidden" class="letra6" id="pagar<?= $i?>" />
                                                            <input name="concepto<?= $i?>" type="hidden" class="letra6" id="concepto<?= $i?>" />
                                                        <? } }?>
                                                    </table>
                                                </div>
                                            </div>
