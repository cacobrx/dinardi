...
$carteltarea="Agrega Nuevo Pedido";
$botoncap="Agregar";
$fecha=date("Y-m-d");
...
<div id="barcentral">
<form name="form1" id="form1" action="adm_cped_add_save.php" method="post">
    <tr>
                            ...
                            <div id="effect-panelmax" class="ui-widget-content ui-corner-all">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="letra6">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select name="idcli" id="idcli"onchange="javascript: document.form1.target='_self'; document.form1.action='adm_cped_add.php'; document.form1.submit()">
                                                <?
                                    ...
                                    <tr>
                                        <td colspan="2" align="center">
                                            <input type="submit" name="Submit" value="<?= $botoncap?>" onclick="javascript: document.form1.action='adm_cped_add_save.php'; document.form1.submit()" />
                                        </td>
                                    </tr>
                                </table>
                            </div>
