<?php
/*
 * Creado el 07/10/2019 11:29:10
 * Autor: gus
 * Archivo: adm_inf_compras.php
...
if($primero==1) {
    if($informe==1)
        ...
        $inf=new inf_compras_prv($fechaini, $fechafin, $orden, $idprv, $idart, $sinfaena, $sinfaena);
                        ...
                        <div class="panel960 letra6">
                            <div id="effect-panel960" class="ui-widget-content ui-corner-all">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="letra6">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="submit" name="cmdOk" id="cmdOk" value="Informe x Artículo" onclick="javascript: document.form1.target='_self'; document.form1.informe.value=1; document.form1.action='adm_inf_compras.php'; document.form1.submit()" />
                                            <input type="submit" name="cmdOk" id="cmdOk" value="Informe x Proveedor" onclick="javascript: document.form1.target='_self'; document.form1.informe.value=2; document.form1.action='adm_inf_compras.php'; document.form1.submit()" />
                                            <input name="cmdPrint" id="cmdPrint" type="submit" value="Imprimir" onclick="javascript: document.form1.target='_blank'; document.form1.action='adm_inf_compras_prn.php'; document.form1.submit()" /> 
                                            <input name="cmdexp" id="cmdexp" type="submit" value="Exportar" onclick="javascript: document.form1.target='_self'; document.form1.action='adm_inf_compras_exp.php'; document.form1.submit()" /> 
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="letra6">
                                                <tr class="letra6bold">
                                                    <td width="50%" align="left">
                                                        <? if($informe==1) echo "Producto"; else echo "Proveedor";?>
                                                    </td>
                                                ...
                                                <tr onMouseOver="overTR(this,'<?= $cfg->getColorbarra()?>')" onMouseOut="overTR(this,'#ffffff')">
                                                    <td align="left">
                                                        <? echo  $a_art[$i];
                                                        if($informe==1) echo " (".$a_idart[$i].")"?>
                                                    </td>
                                                    <td align="right"><?= number_format($a_can[$i],2)?></td>
                                                    <td align="right"><?= number_format($a_neto[$i]/$a_can[$i],2)?></td>
