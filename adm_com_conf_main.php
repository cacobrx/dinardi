...
$ssql="select * from adm_com_conf";
$ssql.=" order by idtipo";
//echo $ssql;
$adm=new adm_com_conf_2($ssql);
...
<body>
    ...
    <div id="barcentral">
        <form name="form1" id="form1" action="adm_com_conf_main_save.php" method="post">
            <tr>
                            ...
                            <td>
                                <div class="panel960 letra6">
                                    <div id="effect-panel960" class="ui-widget-content ui-corner-all">
                                        <h3 class="ui-widget-header ui-corner-all">CONFIGURACIÓN CUENTAS DE COMPRAS</h3>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="2">
                                            <tr>
                                                <td>
                                                    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="letra6">
                                                        <tr class="letra6bold">
                                                            <td width="40%" align="tipo">Tipo</td>
                                                            <td width="40%" align="left">Cuenta</td>
