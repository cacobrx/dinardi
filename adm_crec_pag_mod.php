<?php
/*
 * Creado el 04/12/2020 12:41:17
 * Autor: gus
 * Archivo: adm_crec_pag_mod.php
...
$idcht=$adm->getIdcht();
$detallepago=$adm->getDetallepago();
...
<div id="barcentral">
    <form name="form1" id="form1" action="adm_crec_pag_mod_save.php" method="post">
    <tr >
                    ...
                    <td>
                        <div class="panel960 letra6">
                            <div id="effect-panel960" class="ui-widget-content ui-corner-all">
                                <h3 class="ui-widget-header ui-corner-all">Modifica Detalle de Pago</h3>                
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0">
                                    ...
                                    <tr>
                                        ...
                                        <td width="65%"><input name="detalle" type="text" id="detalle" size="50" maxlength="50" value="<?= $detalle?>" /></td>
                                    </tr>
                                    <tr>
                                        <td align="right">Importe&nbsp;</td>
                                        <td ><input name="importe" type="text" id="importe" value="<?= $importe?>" required onkeypress="return validar_punto(event)" style='text-align: center' /></td>
                                    </tr>
                                    <tr>
                                        <td align="right">ID Cheque&nbsp;</td>
                                        <td>
                                            <input name="idcht" id="idcht" type="text" size="6" value="<?= $idcht?>" onkeypress="return validar(event)" style='text-align: center' />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
