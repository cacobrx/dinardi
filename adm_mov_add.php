<?php
/*
 * Creado el 11/07/2019 20:30:41
 * Autor: gus
 * Archivo: adm_mov_add.php
...
<div id="barcentral">
<form name="form1" id="form1" action="adm_mov_add_save.php" method="post">
    <tr>
        ...
        <input name="cantidaddet" id="cantidaddet" type="hidden" value="2" />
    </tr>
                                                ...
                                                <div id="effect-panel910" class="ui-widget-content ui-corner-all">
                                                    ...
                                                    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" id="item_table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input name="det_detalle<?= $i?>" id="det_detalle<?= $i?>" type="text" class="letra6" size="30" maxlength="30" />
                                                            </td>
                                                            <td align="center">
                                                                <input name="det_entrada<?= $i?>" id="det_entrada<?= $i?>" type="text" class="letra6" size="10" maxlength="10" style="text-align: center" onkeypress="return validar_punto(event)" onblur="Validar_Contable(<?= $canti?>)" />
                                                            </td>
                                                            <td align="center">
                                                                <input name="det_salida<?= $i?>" id="det_salida<?= $i?>" type="text" class="letra6" size="10" maxlength="10" style="text-align: center" onkeypress="return validar_punto(event)" onblur="Validar_Contable(<?= $canti?>)" />
                                                            </td>
                                                        </tr>
                                                        <? } ?>
                                                    </table>
