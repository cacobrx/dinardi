...
//            echo $ssql;
    ...
    //            echo $ssql."<br>";
                if($conx->getCantidadRegA($ssql, $conn)>0) {
                    ...
                    if($soloprecioclip==1 and $rpp->importe==0) $pasa=0;
                    if($pasa==1) {
                        ...
                        array_push($this->pre_seleccionado,$rpp->seleccionado);
                    }
                } else {
                    $pasa=1;
                    ...
                    if($pasa==1) {
                        ...
                        array_push($this->pre_seleccionado,0);
                    }
                }
                if($pasa==1) {
    ...
    function getPreseleccionado() { return $this->pre_seleccionado; }
