                            ...
                            <div id="effect-panel960" class="ui-widget-content ui-corner-all">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="letra6">
                                    ...
                                    <tr>
                                        ...
                                        <td class="letra6bold"><?= $hielo?></td>
                                    </tr>
                  
                                    <tr>
                                        <td align="right">Temp&nbsp;</td>
                                        <td class="letra6bold"><?= $temperatura?></td>
                                    </tr>
                  
                                    <tr>
                                        <td align="right">Tunel&nbsp;</td>
                                        <td class="letra6bold"><?= $tunel?></td>
                                    </tr>
                  
                                    <tr>
                                        <td align="right">Control Organoleptico&nbsp;</td>
                                        <td class="letra6bold"><?= $control?></td>
                                    </tr>
                  
                                    <tr>
                                        <td align="right">Contaminante fisico&nbsp;</td>
                                        <td class="letra6bold"><?= $contaminante?></td>
                                    </tr>
                  
                                    <tr>
                                        <td align="right">Kg rechazo&nbsp;</td>
                                        <td class="letra6bold"><?= $kgrechazo?></td>
                                    </tr>
