...
$d_id=$adm->getDet_id();
$d_detalle=$adm->det_detalle;
$d_importe=$adm->det_importe;
                        ...
                        <div class="panel960 letra6">
                            <div id="effect-panel960" class="ui-widget-content ui-corner-all">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="2">
                                    <tr>
                                        <td><a href="javascript: document.form1.action='adm_com_var_main.php'; document.form1.submit()"><i class="fas fa-arrow-left fa-lg" title="Volver" alt="Volver" /></a></td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0">
                                                ...
                                                <tr>
                                                    <td width="16%">Neto 17%&nbsp;</td>
                                                    <td width="16%" class="letra6bold"><?= number_format($adm->getNeto17(),2)?></td>
                                                    <td width="16%">Iva 17%&nbsp;</td>
                                                    <td width="16%" class="letra6bold"><?= number_format($adm->getiva17(),2)?></td>                                                </tr>                                                
                                                <tr>
                                            ...
                                            <div class="panel910 letra6">
                                                <div id="effect-panel910" class="ui-widget-content ui-corner-all">
                                                    <table width="100%" border="0" cellpadding="2" cellspacing="0">
                                                        <tr class="letra6bold">
                                                            <td>Detalle</td>
                                                            <td width="40%">Descriptores</td>
                                                            <td width="10%" align="right">Importe</td>
                                                        </tr>
                                                        <? for($d=0;$d<count($d_id);$d++) { ?>
                                                        <tr onMouseOver="overTR(this,'<?= $cfg->getColorbarra()?>')" onMouseOut="overTR(this,'#ffffff')">
                                                            <td><?= $d_detalle[$d]?></td>
                                                            <td><?= $d_des1[$d]." / ".$d_des2[$d]." / ".$d_des3[$d]." / ".$d_des4[$d]." / "?></td>
                                                            <td align="right"><?= number_format($d_importe[$d],2)?></td>
                                                        </tr>
                                                        <? } ?>
                                                    </table>
                                                </div>
