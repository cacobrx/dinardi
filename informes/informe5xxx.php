...
//        echo "fechaini: $fechaini | fechafin: $fechafin<br>\n";
        ...
        // ingresos
        if($civa==1)
            $ssql="select sum(netori21+netori10+netocf21+netocf10) as totaling from adm_fis where fecha>='$fechaini' and fecha<='$fechafin' and (tipo='F' or tipo='G' or tipo='H' or tipo='D')";
        else 
            $ssql="select sum(netori21+netori10) as totaling from adm_fis where fecha>='$fechaini' and fecha<='$fechafin' and (tipo='F' or tipo='G' or tipo='H' or tipo='D')";
...
//        echo $ssql."\n";
        ...
        if($civa==1)
            $ssql="select sum(neto21+neto10+iva21+iva10+perretiibb) as totcom1 from adm_com where fecha>='$fechaini' and fecha<='$fechafin' and tipocom!=2 and tipo=1";
        else
...
//        echo $ssql."\n";
        ...
        if($civa==1)
            $ssql="select sum(neto21+neto10+iva21+iva10+perretiibb) as totcom2 from adm_com where fecha>='$fechaini' and fecha<='$fechafin' and tipocom=2 and tipo=1";
        else
