...
//    function getImporteretenido() { return $this->importeretenido; }
    ...
    function getSanitario() { return $this->sanitario; }
    ...
    function __construct($ssql, $tipocontable=0, $conn="0") {
        ...
        if($conx->getCantidadRegA($ssql,$conn)>0) {
            ...
            while($reg=mysqli_fetch_object($rs)) {
                ...
                array_push($this->sanitario,$reg->sanitario);
                if($reg->tipocom!=2) {
...
//                $ssql="select * from adm_com where ptovta=".$reg->ptovta." and numero=".$reg->numero." and idprv=".$reg->idprv;
