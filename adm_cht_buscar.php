<?php
/*
 * Creado el 20/03/2019 14:56:04
 * Autor: gus
 * Archivo: adm_cht_buscarcht.php
...
$hoy30=date("Y-m-d");
$hoy30=date("Y-m-d", strtotime("$hoy30 - 30 days"));
$ssql="select * from adm_cht where (entregado='' or entregado is null) and tipo=$tipo and fechapago>='$hoy30' order by fechapago";
//echo $ssql;
