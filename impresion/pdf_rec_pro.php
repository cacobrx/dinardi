...
class pdf_rec_pro extends pdf_function {
    // private variables
    var $colonnes;
    var $format;
    var $angle=0;
...
//        $this->addCliente( $cfg->getEmpresa(), $cfg->getTelefono());
        ...
        $this->fact_dev( utf8_decode("Recibos Proveedor"),0,120);
...
//        $this->TituloRec("Gastos");
        ...
        $this->SetX($colu[2]);
        $this->Cell(20,5,utf8_decode("Proveedor"),0,0,"L");
        $this->SetX($colu[3]);
        $this->Cell(20,5,"Tipo",0,0,"L");
        $this->SetX($colu[4]);
        $this->Cell(20,5,"Detalle",0,0,"L");
        $this->SetX($colu[5]);
    ...
    function Detalle() {
        ...
        for($i=0;$i<count($a_id);$i++) {          
            ...
            $this->SetX($colu[2]);
            $this->Cell(20,5,utf8_decode($a_pro[$i]),0,0,"L");
            $this->SetX($colu[3]);
