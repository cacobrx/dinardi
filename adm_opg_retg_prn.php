<?php
/*
 * Creado el 03/04/2020 15:20:54
 * Autor: gus
 * Archivo: adm_opg_retg_prn.php
...
while($reg=mysqli_fetch_object($rs)) {
    if($reg->id<=$idop) {
        ...
        $retenciontotal+=$reg->retencionganancia;
        if($reg->id<$idop) $retencionanterior+=$reg->retencionganancia;
    }
}
...
$pdf = new retencionganancia('P', 'mm', 'A4');
$pdf->AddPage();
$pdf->addDetalle();
$pdf->Output();
