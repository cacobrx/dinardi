                        ...
                        <div class="panel960 letra6">
                            <div id="effect-panel960" class="ui-widget-content ui-corner-all">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="letra6">
                                    <tr>
                                        <td>
                                            Fecha hasta <input name="fechafin" id="fechafin" type="date" class="letra6" value="<?= $fechafin?>" /> | 
                                            Ver Saldos en Ceros <input name="versaldocero" id="versaldocero" type="checkbox" <? if($versaldocero==1) echo "checked='$checked'"; ?> /> | 
                                            <input type="submit" name="cmdOk" id="cmdOk" value="Obtener Informe" onclick="javascript: document.form1.tatget='_self'; document.form1.action='adm_cli_saldos.php'; document.form1.submit()"  /> 
                                            <input type="submit" name="cmdprn" id="cmdprn" value="Imprime" onclick="javascript: document.form1.target='_blank'; document.form1.action='adm_cli_saldos_prn.php'; document.form1.submit()" /> 
                                            <input type="submit" name="Submit" value="Exportar" onClick="javascript: document.form1.target='_self'; document.form1.action='adm_cli_saldos_exp.php'; document.form1.submit()" /> 
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            <table width="100%" border="0" cellpadding="2" cellspacing="0">
                                                <tr bgcolor="<?= $cfg->getColor1()?>" style="color: white; font-weight: bold">
                                                    <td align="right">Totales&nbsp;</td>
                                                    <td align="right"><?= number_format($totalcompra,2)?></td>
                                                    <td align="right"><?= number_format($totalpago,2)?></td>
                                                    <td align="right"><?= number_format($totalcompra-$totalpago,2)?></td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr class="letra6bold">
