...
if($tarea=="A") {
    $numero=0;
    $ptovta=0;
    $ssql="Select * from adm_rem_exp order by numero desc limit 1";
    if($conx->getCantidadReg($ssql)>0){
        $rs=$conx->getConsulta($ssql);
        $rss= mysqli_fetch_object($rs);
        $numero=$rss->numero+1; 
        $ptovta=$rss->ptovta;
    }
...
<div id="barcentral">
<form name="form1" id="form1" action="adm_rem_exp_add_save.php" method="post">
    <tr>
                            ...
                            <div id="effect-panel960" class="ui-widget-content ui-corner-all">
                                ...
                                <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="letra6">
                                    ...
                                    <tr>
                                        ...
                                        <td><input name="cuit" type="text" class="letra6" id="cuit" size="11" maxlength="11" value="<?= $cuit?>" onkeypress="return validar(event)" /></td>                                                                      
                                    </tr>
                                    <tr>
                                            ...
                                            <div class="panelmax710 letra6">
                                                <div id="effect-panelmax710" class="ui-widget-content ui-corner-all">
                                                    <table width="100%" border="0" align="center" cellpadding="2" cellspacing="0" class="letra6" id="item_table">
                                                        ...
                                                        <tr>                                                                
                                                            <td><input type="text" id="item_cantidad0" name="item_cantidad0" size="6" maxlength="6" onkeypress="return validar_punto(event)" style="text-align: center" /></td>
                                                            <td><input type="text" id="item_descripcion0" name="item_descripcion0" size="50" maxlength="50" /></td>
                                                            <td><input type="text" id="item_kgsb0" name="item_kgsb0" size="10" maxlength="10" onkeypress="return validar_punto(event)" style="text-align: center" /></td>
                                                            <td><input type="text" id="item_kgsn0" name="item_kgsn0" size="10" maxlength="10" onkeypress="return validar_punto(event)" style="text-align: center"/></td>
